...
[![My Skills](https://skillicons.dev/icons?i=tailwind,mui,react,nextjs,vue,ts,nodejs,nestjs,express,flutter,dart,laravel,mysql,postgres,prisma)](https://skillicons.dev) 
